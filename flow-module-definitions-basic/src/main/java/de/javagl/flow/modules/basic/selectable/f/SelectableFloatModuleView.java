...
/**
 * Implementation of a {@link ModuleView} for a {@link SelectableFloatModule}
 */
public final class SelectableFloatModuleView 
    extends JPanel implements ModuleView
{
    /**
     * The {@link Module}
     */
    private SelectableFloatModule module;
    ...
    public SelectableFloatModuleView()
    {
        ...
        spinner.addChangeListener(e -> 
        {
            if (module != null)
            {
                ...
                module.getConfiguration().setValue(number.floatValue());
            }
        });
        ...
        propertyChangeListener = new PropertyChangeListener()
        {
            ...
            public void propertyChange(PropertyChangeEvent event)
            {
                ...
                spinner.setValue(newValue.floatValue());
            }
        };
    ...
    public void setModule(Module module)
    {
        ...
        if (this.module != null)
        {
            FloatBean bean = this.module.getConfiguration();
            bean.removePropertyChangeListener(propertyChangeListener);
        }
        this.module = (SelectableFloatModule) module;
        if (this.module != null)
        {
            FloatBean bean = this.module.getConfiguration();
